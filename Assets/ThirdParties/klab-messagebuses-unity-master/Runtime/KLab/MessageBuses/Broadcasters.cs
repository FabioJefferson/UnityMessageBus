...
namespace KLab.MessageBuses.Broadcasters
{
    ...
    /// </summary>
    /// <typeparam name="Move">Message type</typeparam>
    internal sealed class Broadcaster<Move>
    {
        /// <summary>
        /// Connections
        /// </summary>
        private readonly List<Action<Move>> Connections;
        ...
        public Broadcaster(int connectionsCapacity)
        {
            Connections = new List<Action<Move>>(connectionsCapacity);
        }
        ...
        /// </summary>
        /// <param name="handler">Handler to connect</param>
        public void Connect(Action<Move> handler)
        {
            // Early out if handler invailed
            if (handler == null) { return; }
        ...
        /// </summary>
        /// <param name="handler">Handler to disconnect</param>
        public void Disconnect(Action<Move> handler)
        {
            // Early out if handler invailed
            if (handler == null) { return; }
        ...
        public void Broadcast(Move message)
        {
            var connections = Connections;
            var count = Connections.Count;
